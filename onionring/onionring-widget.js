...
<table>
  ...
  <table>
    <tr>
      ...
      <td class='webring-info'>${ringName}</td>
      <td class='webring-next'><a href='${sites[nextIndex]}'>next →</a></td>
    </tr>
    <tr>
    </tr>
      <td><span class='webring-links'>${randomText}</span></td>
      <td><span class='webring-links'>${indexText}</span></td>
      <td><span class='webring-links'><a href='https://garlic.garden/onionring/'>what is?</a></span></td>
    </tr>
  </table>
  `);
